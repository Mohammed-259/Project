...
class OtpScreenupdate extends StatefulWidget {
  ...
  const OtpScreenupdate({super.key, required this.emailOrPhone});

  @override
  State<OtpScreenupdate> createState() => _OtpScreenupdateState();
}
                  ...
                  children: [
                          ...
                          PinCodeTextField(
                            ...
                            pinTheme: PinTheme(
                              ...
                              activeColor: state.hasError
                                  ? Colors.red
                                  : AppColors.blue,
                              inactiveColor: state.hasError
                                  ? Colors.red
                                  : AppColors.grayOtp,
                              selectedColor: state.hasError
                                  ? Colors.red
                                  : AppColors.blue,
                    ...
                    CustomButton(
                      ...
                      textStyle: AppStyles.textStyle14w400FF.copyWith(
                        color: state.hasError ? AppColors.white : Colors.white,
                      ),
                    ),
